...
most_recent_month_in_data <- as.Date("2026-07-31") # maybe could derive value from the dated output folder name instead of human input here (could easily forget to update it)
...
month_end <- as.Date('2026-07-01') #update each month
