...
<Div custom-style = "Table or chart caption">Table 3: PT total appointments and total DNA risk (%) by health board, quarter ending `r date_label` ^a,b,c^</Div>
...
<Div custom-style = "Table or chart caption">Table 4: PT first contact appointments and first contact DNA risk (%) by health board, quarter ending `r date_label`, with DNA risk for first contact appointments ^a,b^</Div>
...
There is a suggestion that the first contact DNA risk percentage has becoming more consistent
across some geographical regions over the last 15 calendar months, which is likely 
due to the improving data quality in CAPTND. For PT, first contact DNA risk 
...
<Div custom-style = "Table or chart caption">Figure 8: First contact DNA risk (%) by health board region, `r date_label_5qt` to `r date_label`^a^</Div>
...
<Div custom-style = "Table or chart caption">Figure 9: First contact DNA risk (%) by SIMD quintile, NHS Scotland, quarter ending `r date_label`</Div>
